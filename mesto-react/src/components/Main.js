        ...
        <main>
            ...
            <section className="elements">
                {props.cards.map((card) =>(
                    <Card key={card._id} id={card._id} owner={card.owner} name={card.name} link={card.link} likes={card.likes} onCardClick={props.onCardClick} onCardLike={props.onCardLike} onCardDelete={props.onCardDelete}></Card>))
                }
            </section>
        </main>
    );
